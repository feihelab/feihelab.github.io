...
My current research interests lie at the interface of control systems engineering, signal processing and neuroscience - especially the use of nonlinear system identification and frequency-domain techniques to study complex nonlinear interactions in human brain network and the diagnosis of neurological disorders (e.g. Alzheimer’s disease, tremor, seizures). I am also interested in statistical machine learnig, network inference and their applications in neuroscience and systems biology, such as identifying complex regulatory mechanisms in cellular (metabolic, genetic) networks.
...
1. [Jan 2023] I have a fully-funded PhD studentship (jointly with ASTAR) for Sep 2023 start, on the topic of deep learning, brain network and dynamical system (more details to follow). Interested candidates please send me your CV. 
